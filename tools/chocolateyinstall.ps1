...
$url        = 'https://taiga.moe/update/TaigaSetup.exe' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'taiga*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
